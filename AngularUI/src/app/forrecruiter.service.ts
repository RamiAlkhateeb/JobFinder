...
constructor(private httpCli:HttpClient) { }
  ...
  recruiter_register(body:any){
    return this.httpCli.post(`${PUBLIC}auth/register`,body,
    {
      observe:'body',
      headers:new HttpHeaders().append('Content-Type','application/json')
    }
...
//   }
  getpostedjobs()
  {
    ...
    return this.httpCli.get(`${PRIVATE}jobs/postedjobs/${this.getpayload().id}`,httpOptions);
  }
  getseekers()
  {
    const httpOptions = {
...
postjob(body:any)
{
  ...
  return this.httpCli.post(`${PRIVATE}jobs`,body,httpOptions);
}
getpayload()
{
